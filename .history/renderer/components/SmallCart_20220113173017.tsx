    ...
    <>
      <div
        ...
        className={
          ...
          'z-50 fixed bottom-0 transform translate-x-0 inset-x-auto w-full'
        }
        ref={popoverRef}
      >
        {isCartLoading && (
        ...
        {!isEmpty && (
          <div className="divide-y border-b bg-white">
            ...
            <SimpleBar className="mb-32 overflow-x-scroll h-[calc(220px)]">
              {data &&
                data?.lineItems.map((lineItem: any) => (
                  <div key={lineItem.id} className="w--1/5 py-3 pr-2">
                    <div>
                      {lineItem.child &&
            ...
            <div className="flex h-32 fixed bottom-0 w-full">
              <div className="flex text-center bg-teal-500 w-full h-full">
                <div 
                  ...
                  onClick={clearBasket}>Отменить</div>
                <div 
