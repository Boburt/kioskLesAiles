...
const SignInModal: FC<SmallCartProps> = ({ channelName }) => {
          ...
          <div className="min-h-screen px-4 text-center">
            ...
            >
              <div className="inline-block bg-white">
                <div className="">
                  <div className="bg-[#7C40C6] my-96 relative shadow-xl transform">
                    <button
                    ...
                    {/* <Dialog.Title className="text-6xl font-serif font-bold text-white pt-16 mb-12 mx-24">
                    ...
                    {!user && isShowPasswordForm && (
                      <div>
                        ...
                        >
                          <div className="mt-10">
                            <label className="text-6xl font-serif font-bold text-white pt-16 mb-12 mx-24">
                              {tr("sms_code")}
                            </label>
                            <OtpInput
                              value={otpCode}
                              onChange={handleOtpChange}
                              inputStyle={`${styles.digitField}  w-[91px] rounded-3xl h-[100px] text-center px-12`}
                              isInputNum={true}
                              containerStyle="grid grid-cols-4 gap-5 justify-center"
                              numInputs={4}
                            />
                            {otpShowCode > 0 ? (
                              <div className="text-xs text-primary mt-10">
                                {otpTimerText}
                              </div>
                            ) : (
                              <button
                      ...
                      <>
                        <form onSubmit={handleSubmit(onSubmit)}>
                          <div className="pt-[60px]">
                            <label className="text-6xl font-serif font-bold text-white mx-24">
                              {tr("personal_phone")}
                            </label>
                              ...
                              <Controller
                                render={({ field: { onChange, value } }) => (
                                  <Input
                                    ...
                                    value={value}
                                    className="border-solid rounded-lg w-[456px] h-[100px] bg-white text-5xl"
                          ...
                          <div className="mt-10">
                            <button
                              className={`py-12 text-white font-semibold text-5xl text-center w-full  ${
                                formState.isValid
                                  ? "bg-greenPrimary"
                                  : "bg-gray-400"
                              }`}
