...
const PayWithPoints = () => {
  ...
  return (
    <div className="bg-primary h-full text-white">
      ...
      <div className="bottom-0 fixed flex font-sans justify-between w-full">
        <div className="bg-black py-9">Назад</div>
        <div className="bg-greenPrimary text-white fixed right-0 bottom-0 py-9 px-52 font-medium text-[40px] font-sans">
          Списать с бонуса
        </div>
      </div>
    </div>
