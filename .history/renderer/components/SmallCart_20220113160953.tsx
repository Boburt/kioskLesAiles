...
const SmallCart: FC<SmallCartProps> = ({ channelName }) => {
  ...
  return (
    <>
      <button
        className="outline-none focus:outline-none bottom-20 right-4 divide-x-2 md:flex px-4 bg-primary h-10 items-center justify-around rounded-xl text-white"
        type="button"
      ...
      <div
        ...
        className={
          (popoverShow ? '' : 'hidden ') +
          'z-50 transform translate-x-0 inset-x-auto w-full'
        }
        ref={popoverRef}
      >
        {isCartLoading && (
