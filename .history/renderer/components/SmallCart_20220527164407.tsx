  ...
  return (
    <>
      ...
      >
        ...
        <div className="flex text-center  w-full justify-center items-center py-40 text-3xl">
          <div
            className="text-2xl text-white bg-black w-full h-full"
            onClick={openCancelModal}
          >
            <div className="font-medium">{tr("profile_address_cancel")}</div>
          </div>
          <div
            className=" bg-greenPrimary text-white w-full h-full"
