                  ...
                  {cashbackStep == "agreement" && (
                    <div>
                      ...
                      <div className="bg-white text-black font-medium text-4xl font-mono mx-44 px-12 my-12">
                        <div className="flex">
                          <div className="bg-gray-300 p-12 rounded-xl">1</div>
                          <div className="bg-gray-300 p-12 rounded-xl">2</div>
                          <div className="bg-gray-300 p-12 rounded-xl">3</div>
                        </div>
                        <div className="flex">
                          <div className="bg-gray-300 p-12 rounded-xl">4</div>
                          <div className="bg-gray-300 p-12 rounded-xl">5</div>
                          <div className="bg-gray-300 p-12 rounded-xl">6</div>
                        </div>
                        <div className="flex">
                          <div className="bg-gray-300 p-12 rounded-xl">7</div>
                          <div className="bg-gray-300 p-12 rounded-xl">8</div>
                          <div className="bg-gray-300 p-12 rounded-xl">9</div>
                        </div>
                      </div>
                      <div className="">
                        <button
