                  ...
                  {cashbackStep == "agreement" && (
                    <div>
                      ...
                      <div className="bg-white text-black font-medium text-4xl font-mono mx-44 px-12 my-12">
                        <div className="flex">
                          <div className="bg-gray-300 px-14">1</div>
                          <div className="bg-gray-300 px-14">2</div>
                          <div className="bg-gray-300 px-14">3</div>
                        </div>
                        <div className="flex">
                          <div className="bg-gray-300 px-14">4</div>
                          <div className="bg-gray-300 px-14">5</div>
                          <div className="bg-gray-300 px-14">6</div>
                        </div>
                        <div className="flex">
                          <div className="bg-gray-300 px-14">7</div>
                          <div className="bg-gray-300 px-14">8</div>
                          <div className="bg-gray-300 px-14">9</div>
                        </div>
                      </div>
                      <div className="">
                        <button
