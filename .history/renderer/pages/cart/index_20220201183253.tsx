                ...
                <div className="bg-plum my-96 relative shadow-xl transform mx-28 text-white">
                  ...
                  {cashbackStep == "agreement" && (
                    <div>
                      ...
                      <div className="bg-white text-black font-medium text-4xl font-mono mx-44 p-12 my-12 rounded-2xl">
                        <div className="grid grid-cols-3 gap-2 text-6xl">
                          <div className="bg-gray-300 rounded-xl">1</div>
                          <div className="bg-gray-300 rounded-xl">2</div>
                          <div className="bg-gray-300 rounded-xl">3</div>

                          <div className="bg-gray-300 rounded-xl">4</div>
                          <div className="bg-gray-300 rounded-xl">5</div>
                          <div className="bg-gray-300 rounded-xl">6</div>
                          <div className="bg-gray-300 rounded-xl">7</div>
                          <div className="bg-gray-300 rounded-xl">8</div>
                          <div className="bg-gray-300 rounded-xl">9</div>
                        </div>
                      </div>
                      <div className="">
                        <button
