            ...
            >
              <div className="align-middle inline-block overflow-hidden w-full z-[200]">
                <div className="bg-plum my-96 relative shadow-xl transform mx-28 text-white">
                  ...
                  <div className="font-serif text-6xl pt-14 pb-16 px-28">
                    Хотите получить кешбек 5%?
                  </div>
                  <div>
                    Чтобы получить кешбек, надо просто указать номер телефона и
                    личные данные Оплатить заработанными бонусами можно все
                    товары
                  </div>
