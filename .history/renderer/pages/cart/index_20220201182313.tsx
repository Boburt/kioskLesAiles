                  ...
                  {cashbackStep == "agreement" && (
                    <div>
                      ...
                      <div className="bg-white text-black font-medium text-4xl font-mono mx-44 px-12 my-12">
                        <div className="flex">
                          <div className="bg-gray-300 px-3">1</div>
                          <div className="bg-gray-300 px-3">2</div>
                          <div className="bg-gray-300 px-3">3</div>
                        </div>
                        <div className="flex">
                          <div className="bg-gray-300 px-3">4</div>
                          <div className="bg-gray-300 px-3">5</div>
                          <div className="bg-gray-300 px-3">6</div>
                        </div>
                        <div className="flex">
                          <div className="bg-gray-300 px-3">7</div>
                          <div className="bg-gray-300 px-3">8</div>
                          <div className="bg-gray-300 px-3">9</div>
                        </div>
                      </div>
                      <div className="">
                        <button
